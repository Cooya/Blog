        ...
        return [
            ...
            },
            {
                ...
                replace: function (s, url) {
                    ...
                    return '<div class="item column is-one-quarter-desktop is-one-third-tablet is-half-mobile" data-src="' + url + '" data-responsive="' + data + '">' + s + '</div>'
                }
            },
            {
                type: 'output',
                ...
                replace: function (s, match) {
                    return '<div class="lightgallery columns is-centered is-multiline is-mobile is-variable is-1">' + match + '</div>';
                }
            }
        ];
    };
